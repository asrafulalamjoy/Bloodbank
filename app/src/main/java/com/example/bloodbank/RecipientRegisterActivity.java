        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bloodGroup.equals("Select Your Blood Group")) {
                    Toast.makeText(RecipientRegisterActivity.this, "Select Blood Group", Toast.LENGTH_LONG).show();
                }
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(RecipientRegisterActivity.this, "Data Set Successfully", Toast.LENGTH_SHORT).show();
                                        } else {
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()) {
                                                                    Toast.makeText(RecipientRegisterActivity.this, "Image url added to database successfully", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(RecipientRegisterActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
