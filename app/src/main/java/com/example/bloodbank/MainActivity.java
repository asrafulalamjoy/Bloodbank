...
import static com.example.bloodbank.R.string.navigation_drawer_close;
import static com.example.bloodbank.R.string.navigation_drawer_open;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(MainActivity.this, drawerLayout,
                toolbar, navigation_drawer_open, navigation_drawer_close);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (snapshot.hasChild("profilepictureurl")) {
                        ...
                        nav_profile_image.setImageResource(R.drawable.avataricon);
                    }
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (userList.isEmpty()){
                    Toast.makeText(MainActivity.this,
                            "No donor", Toast.LENGTH_SHORT).show();
                    progressbar.setVisibility(View.GONE);
                }
            }
